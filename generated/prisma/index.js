...
const config = {
  generator: {
    ...
    output: {
      value:
        "/home/benedikt/Git/streamline-scheduler-webpage/streamline-scheduler-webpage/generated/prisma",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
    ...
    previewFeatures: [],
    sourceFilePath:
      "/home/benedikt/Git/streamline-scheduler-webpage/streamline-scheduler-webpage/prisma/schema.prisma",
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
...
path.join(
  process.cwd(),
  "generated/prisma/libquery_engine-linux-nixos.so.node",
);
// file annotations for bundling tools to include these files
